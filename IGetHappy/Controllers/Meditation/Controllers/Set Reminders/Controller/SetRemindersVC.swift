...
class SetRemindersVC: UIViewController,UIScrollViewDelegate,UITextFieldDelegate
{
    ...
    @IBAction func ACTION_ADD(_ sender: Any)
    {
        ...
        {
            CommonVc.AllFunctions.showAlert(message: "In order to create a reminder, you must have to select date first.", view: self, title: "Oops!")
        }
        else
        {
    ...
    @IBAction func ACTION_SELECT_END_DATE_RECURRING(_ sender: Any)
    {
        ...
        {
            CommonVc.AllFunctions.showAlert(message: "Please select start date first", view: self, title: "Oops!")
        }
        else
        {
            self.selectedApproach = "Ongoing"
    ...
    @IBAction func ACTION_ADD_RECURRING_REMINDER(_ sender: Any)
    {
        if (btnOngoing.tag == 0)// on going is not selected its a start date and Date
        {
            ...
            {
                CommonVc.AllFunctions.showAlert(message: "Please select end date", view: self, title: "Oops!")
            }
            else if(self.tf_recurringMsg.text == "")
            {
                 CommonVc.AllFunctions.showAlert(message: "Please add some words to remind you on Alert.", view: self, title: "Oops!")
            }
            else if(recurring_index == -1)
            {
                CommonVc.AllFunctions.showAlert(message: "In order to create a recurring reminder, you must have to select a repeat day.", view: self, title: "Oops!")
            }
            else if (self.tf_alertTime_recurring.text?.count == 0)
            {
                CommonVc.AllFunctions.showAlert(message: "Please choose alert time for reminder.", view: self, title: "Oops!")
            }
            else
            {
        ...
        else//ongoing selected
        {
            ...
            else
            {
                ...
                {
                    CommonVc.AllFunctions.showAlert(message: "Please choose alert time for Ongoing Reminders.", view: self, title: "Oops!")
                }
                else
                {
