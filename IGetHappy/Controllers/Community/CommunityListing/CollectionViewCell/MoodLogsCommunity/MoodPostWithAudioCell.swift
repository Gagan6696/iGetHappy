...
@objc protocol MoodPostWithAudioCellDelegate
{
...
class MoodPostWithAudioCell: UICollectionViewCell
{
    ...
    var delegate: MoodPostWithAudioCellDelegate?
...
extension MoodPostWithAudioCell :UITableViewDataSource,UITableViewDelegate{
...
extension MoodPostWithAudioCell:CommentCellDelegate{
