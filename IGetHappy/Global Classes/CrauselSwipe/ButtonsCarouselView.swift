...
final class ButtonCarouselView : UITableViewCell, CircularCarouselDataSource, CircularCarouselDelegate {
    ...
    func carousel<CGFloat>(_ carousel: CircularCarousel, valueForOption option: CircularCarouselOption, withDefaultValue defaultValue: CGFloat) -> CGFloat {
        switch option {
        case .itemWidth:
            return (delegate?.itemWidth(forButtonCarousel: self) ?? Constant.defaultButtonWidth) as! CGFloat
            
        case .scaleMultiplier:
            return Constant.scaleMultiplier as! CGFloat
        
        case .minScale:
            return Constant.minScale as! CGFloat
        
        case .maxScale:
            return Constant.maxScale as! CGFloat
        
        case .fadeMin:
            return Constant.minFade as! CGFloat
        
        case .fadeMax:
            return Constant.maxFade as! CGFloat
