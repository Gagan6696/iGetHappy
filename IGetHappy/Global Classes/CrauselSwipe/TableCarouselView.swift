...
final class TableCarouselView: UITableViewCell,
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellSelectionIdx = (indexPath.row + tableView.tag) % DataCrausel.imageCellSelection.count
        let cellSelection = DataCrausel.imageCellSelection[cellSelectionIdx]
